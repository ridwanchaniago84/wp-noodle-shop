...
final class Base {
    ...
    public function ajax_dismiss() {
        update_user_meta( get_current_user_id(), 'etww_promo_notice', 1 );
        wp_die();
    }
    ...
    public function admin_promo_notice(){
        ...
        if( get_user_meta( get_current_user_id(), 'etww_promo_notice', true ) ){
            return;
        }
    ...
    */
    ...
    public function plugin_deactivation_hook() {
        delete_metadata( 'user', null, 'etww_promo_notice', null, true );
